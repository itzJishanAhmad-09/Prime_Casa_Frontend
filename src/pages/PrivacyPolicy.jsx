        ...
        <main className="privacy-main">
          <div className="privacy-sections">
            ...
            <section id="rights" className="privacy-section">
              <div className="privacy-section-header">
                <span className="privacy-section-icon"><IconGavel size={22} /></span>
                <h2>User Rights</h2>
              </div>
            ...
            <section id="contact" className="privacy-section privacy-section-cta">
              <div className="privacy-section-header">
                <span className="privacy-section-icon"><IconMail size={22} /></span>
                <h2>Contact Information</h2>
              </div>
              <div className="privacy-contact-grid">
                <div>
                  <p><IconMail size={18} color="var(--gold-l)" /> crm@theprimecasa.com</p>
