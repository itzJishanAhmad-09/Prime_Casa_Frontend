        ...
        <div className="services-card-grid">
          <div className="service-card reveal-on-scroll" style={{ transitionDelay: '100ms' }}>
            ...
            <ul className="service-card-list">
              <li><i className="ti ti-circle-check"></i> Tenant Procurement &amp; Screening</li>
              <li><i className="ti ti-circle-check"></i> Maintenance &amp; Oversight</li>
            </ul>
          </div>
          ...
          <div className="service-card reveal-on-scroll" style={{ transitionDelay: '200ms' }}>
            ...
            <ul className="service-card-list">
              <li><i className="ti ti-circle-check"></i> Market Feasibility Studies</li>
              <li><i className="ti ti-circle-check"></i> Investment Portfolio Analysis</li>
            </ul>
          </div>
          ...
          <div className="service-card reveal-on-scroll" style={{ transitionDelay: '300ms' }}>
            ...
            <ul className="service-card-list">
              <li><i className="ti ti-circle-check"></i> High-Value Property Listing</li>
              <li><i className="ti ti-circle-check"></i> Exclusive Buyer Representation</li>
            </ul>
          </div>
        </div>
      </section>
